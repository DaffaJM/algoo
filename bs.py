...
def login():
    ...
    #input memasukkan nama user yang akan dipakai
    password = input('Masukkan Password yang Akan dibuat: ')
    #input memasukkan password user yang akan dipakai

    user = input('Username: ')
    #user memasukkan username yang sudah dibuat tadi
    # sandi = getpass.getpass()
    sandi = input('Password: ')
    #user memasukkan password yang sudah dibuat tadi
    if user == username and sandi == password:
    #menggunakan if untuk menampilkan jika login berhasil dan jika tidak
        print('Login Berhasil')
        #jika username dan password dimasukkan benar maka akan muncul tulisan itu 
    else:
    #jika username dan password yang dimasukkan user tidak sesuai
        print('Username atau Password yang anda masukkan salah !!!')
        #jika tidak sesuai dengan yg dibuat maka akan muncul tulisan itu
